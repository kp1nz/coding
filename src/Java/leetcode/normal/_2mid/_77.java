...
public class _77 {
    public List<List<Integer>> combine(int n, int k) {
        ...
        dfsBetter(n, k, 1, path, res);
        return res;
    }

    private void dfsBetter(int n, int k, int begin, Deque<Integer> path, List<List<Integer>> res) {
